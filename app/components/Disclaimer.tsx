...
const Disclaimer: React.FC = () => (
  <div className="text-xs text-gray-400 font-sans-serif mt-4 bg-gray-100 p-1 rounded-full">
    <p>
      ToonScout only stores your Discord User ID, latest toon data, and your access token in a secure cookie. If you wish for your data to be removed, please contact us at our 

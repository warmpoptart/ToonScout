      ...
      <div className="info-container">
        ...
        <div className="right-info-container">
          ...
          <div className="suits-info-container">
            <div className="suit-card">{displaySuit("s")}</div>
            <div className="suit-card">{displaySuit("m")}</div>
            <div className="suit-card">{displaySuit("l")}</div>
            <div className="suit-card">{displaySuit("c")}</div>
          </div>
        </div>
      </div>
    </div>

    ...
    <div className="modal-container">
      <AnimatedTabContent>
        <div className="modal-content">
          <h3 className="text-3xl mb-2 minnie-title">
          ...
          <div className="space-y-8 pt-2">
            ...
            <div className="faq-container">
              <div className="faq-question">
                What logic is used to calculate my suit promotion, fish
            ...
            <div className="faq-container">
              ...
              <div className="faq-answer">
                The Toon API Calculator currently ranks all facilities by time
                per total facility points (merits, cogbucks, etc). This
                calculation results in the algorithm ignoring long steel
                factories since it believes that short steels are a more
                efficient use of your time. In the future, I plan to add the
                option to switch between the current algorithm and one that will
                recommend skipped facilities like long steel factories.
              </div>
            </div>
          </div>
